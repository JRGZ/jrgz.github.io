...
function setupGUI(config) {
	...
	// Blue
	if (config.legend.blueLabel) {
		$(".blue").next().html(config.legend.blueLabel);
	} else {
		//hide more information link
		$(".blue").hide();
	}
	// Cyan
	if (config.legend.cyanLabel) {
		$(".cyan").next().html(config.legend.cyanLabel);
	} else {
		//hide more information link
		$(".cyan").hide();
	}
	// Yellow
	if (config.legend.yellowLabel) {
		$(".yellow").next().html(config.legend.yellowLabel);
	} else {
		//hide more information link
		$(".yellow").hide()
	}
	// Green
	if (config.legend.greenLabel) {
		$(".green").next().html(config.legend.greenLabel);
	} else {
		//hide more information link
		$(".green").hide();
	}
	// Red
	if (config.legend.redLabel) {
		$(".red").next().html(config.legend.redLabel);
	} else {
		//hide more information link
		$(".red").hide()
	}
